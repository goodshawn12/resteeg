...
path_chanlocs = [path_resteeg filesep 'chanlocs' filesep 'chanlocs_ANTNeuro21.mat'];
...
CONFIG.chan_to_rm = {'ECG', 'AA', 'LABEL'};
...
CONFIG.EXPORT_REPORT = 0;
CONFIG.GEN_FIGURES = 1;
CONFIG.VIS_CLEAN = 0;

% Enable Source Localization - Dipole Fitting
CONFIG.ENABLE_DIPFIT = 0;
CONFIG.COREGISTER = [0 0 0 0 0 -1.58 1.0159 1.0159 1.0159];
