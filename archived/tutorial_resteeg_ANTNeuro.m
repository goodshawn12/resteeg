...
path_chanlocs = [path_resteeg filesep 'chanlocs' filesep 'chanlocs_ANTNeuro64.mat'];
...
CONFIG.chan_to_rm = {'BIP65','BIP66','BIP67','BIP68','AUX69','AUX70','AUX71','AUX72','Digi','Saw'};
...
for file_id = 1:length(CONFIG.filename_list)
    ...
    % run resteeg toolbox
    if CONFIG.DEBUG
        CONFIG = resteeg_ANTNeuro(CONFIG);
    else
        try
            CONFIG = resteeg_ANTNeuro(CONFIG);
        catch
